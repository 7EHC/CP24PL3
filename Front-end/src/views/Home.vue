...
<div>
    <p class="slogan text-6xl ml-3 text-yellow-400 flex flex-col gap-3 bg-zinc-900 w-1/2 p-2 md:w-2/3 sm:w-2/3">
    ...
    <p class="introduce p-2 text-2xl text-zinc-700 leading-10">
        ...
        Welcome to <span class="bg-zinc-900 text-yellow-400 p-1">SIT Invest</span> — your gateway to a realistic investment experience in the U.S. stock market.
